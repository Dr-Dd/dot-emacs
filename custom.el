...
' ' ' | tr -s '	' ' '"))
 ...
 '(elfeed-feeds
   '(("https://www.rfc-editor.org/rfcrss.xml" rfc ietf cs tech)
     ("https://www.kernel.org/feeds/all.atom.xml" cs tech linux)
     ("https://www.kernel.org/feeds/kdist.xml" cs tech linux)
     ("https://www.reddit.com/r/linux/rising/.rss" cs tech reddit)
     ("https://www.reddit.com/r/emacs/rising/.rss" cs tech reddit)
     ("https://lwn.net/headlines/rss" cs tech blog)
     ("https://www.phoronix.com/rss.php" cs tech blog)
     ("https://hackaday.com/blog/feed/" cs tech blog)
     ("https://www.darkreading.com/rss_simple.asp" cs tech blog)
     ("https://feeds.feedburner.com/TheHackersNews" cs tech blog)
     ("https://lobste.rs/rss" cs tech aggregator)
     ("https://hnrss.org/frontpage" cs tech aggregator)
     ("https://dev.to/feed" cs tech aggregator)
     ("https://gizmodo.com/rss" tech blog)
     ("http://rss.slashdot.org/Slashdot/slashdotMain" tech blog)
     ("https://www.engadget.com/rss.xml" tech blog)
     ("https://feeds.feedburner.com/GamasutraNews/" games tech blog)
